        ...
        for filename in os.listdir(folder+"/"+a):
            if filename.lower().endswith('.png'):
                ...
                if img is not None and img.shape[2] == 4:
                    images[a].append(img)
        return images
load_pngs("C:/Users/padma/Downloads/training_data/rotated_nobg")
...
# object_images = load_pngs('objects')
# placed_boxes = []

# # Place objects
# for _ in range(10):
#     img = random.choice(object_images)
#     img_resized = random_resize(img, min_size=30, max_size=100)
...
#         if not is_too_much_overlap(x, y, w, h, placed_boxes, max_iou=0.15):  # Allow small overlap
#             paste_image(background, img_resized, x, y)
#             placed_boxes.append((x, y, w, h))
#             break

# # Show result
# cv2.imshow("Controlled Overlap PNG Placement", background)
# cv2.waitKey(0)
